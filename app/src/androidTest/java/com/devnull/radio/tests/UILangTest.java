...
public class UILangTest {
    ...
    public void application_ShouldNotCrash_WithLanguage() {
        ...
        {
            onView(AllOf.allOf(withId(R.id.buttonMore), isDescendantOfA(RecyclerViewMatcher.withRecyclerView(R.id.recyclerViewStations).atPosition(0)))).perform(ViewActions.click());
        }
