...
import com.devnull.radio.alarm.FragmentAlarm;
import com.devnull.radio.alarm.TimePickerFragment;
import com.devnull.radio.cast.CastAwareActivity;
import com.devnull.radio.interfaces.IFragmentSearchable;
import com.devnull.radio.players.PlayState;
import com.devnull.radio.players.PlayStationTask;
import com.devnull.radio.players.mpd.MPDClient;
import com.devnull.radio.players.mpd.MPDServersRepository;
import com.devnull.radio.players.selector.PlayerType;
import com.devnull.radio.service.MediaSessionCallback;
...
public class ActivityMain extends AppCompatActivity implements SearchView.OnQueryTextListener,
    ...
    private void handleIntent(@NonNull Intent intent) {
        ...
        if (MediaSessionCallback.ACTION_PLAY_STATION_BY_UUID.equals(action)) {
            ...
            final String stationUUID = extras.getString(MediaSessionCallback.EXTRA_STATION_UUID);
            if (TextUtils.isEmpty(stationUUID))
                return;
            intent.removeExtra(MediaSessionCallback.EXTRA_STATION_UUID); // mark intent as consumed
