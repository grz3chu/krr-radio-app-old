...
import com.devnull.radio.BuildConfig;
...
import com.devnull.radio.players.RadioPlayer;
...
public class PlayerService extends JobIntentService implements RadioPlayer.PlayerListener {
    ...
    public static final String PLAYER_SERVICE_TIMER_UPDATE = "com.devnull.radio.timerupdate";
    public static final String PLAYER_SERVICE_META_UPDATE = "com.devnull.radio.metaupdate";

    public static final String PLAYER_SERVICE_STATE_CHANGE = "com.devnull.radio.statechange";
    public static final String PLAYER_SERVICE_STATE_EXTRA_KEY = "state";

    public static final String PLAYER_SERVICE_METERED_CONNECTION = "com.devnull.radio.metered_connection";
    public static final String PLAYER_SERVICE_METERED_CONNECTION_PLAYER_TYPE = "PLAYER_TYPE";

    public static final String PLAYER_SERVICE_BOUND = "com.devnull.radio.playerservicebound";
