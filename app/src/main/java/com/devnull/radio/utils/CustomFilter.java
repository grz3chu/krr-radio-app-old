...
/**
 * This is a copy of {@link CustomFilter} with @hide removed from delayer.
 */
public abstract class CustomFilter {
     ...
     *
     * @see #filter(CharSequence, CustomFilter.FilterListener)
     */
     ...
     * @see #publishResults(CharSequence, CustomFilter.FilterResults)
     */
    public final void filter(CharSequence constraint, CustomFilter.FilterListener listener) {
        synchronized (mLock) {
     ...
     * @see #filter(CharSequence, CustomFilter.FilterListener)
     * @see #publishResults(CharSequence, CustomFilter.FilterResults)
     * @see CustomFilter.FilterResults
     */
    protected abstract CustomFilter.FilterResults performFiltering(CharSequence constraint);
    ...
    protected abstract void publishResults(CharSequence constraint,
                                           CustomFilter.FilterResults results);
     ...
     * {@link CustomFilter#filter(CharSequence, CustomFilter.FilterListener)},
            ...
            switch (what) {
                case FILTER_TOKEN:
                    ...
                    try {
                        ...
                        args.results = new CustomFilter.FilterResults();
    ...
    private class ResultsHandler extends Handler {
         ...
         * {@link CustomFilter#publishResults(CharSequence,
    ...
    private static class RequestArguments {
         ...
         */
        CustomFilter.FilterListener listener;
    ...
    public interface Delayer {
        ...
        /**
         * @param constraint The constraint passed to {@link CustomFilter#filter(CharSequence)}
